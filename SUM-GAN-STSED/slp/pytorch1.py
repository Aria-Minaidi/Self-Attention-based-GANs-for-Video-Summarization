...
def to_device(
    tt: torch.Tensor, device: Optional[types1.Device] = "cpu", non_blocking: bool = False
) -> torch.Tensor:
...
def t_(
    data: types1.NdTensor,
    dtype: torch.dtype = torch.float,
    device: Optional[types1.Device] = "cpu",
...
def from_checkpoint(
    ...
    obj: types1.ModuleOrOptimizer,
    map_location: Optional[types1.Device] = "cpu",
    dataparallel: bool = False,
) -> types1.ModuleOrOptimizer:
