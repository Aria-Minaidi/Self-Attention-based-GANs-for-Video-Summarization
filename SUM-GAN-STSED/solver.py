...
class Solver(object):
    ...
    def build(self):
        ...
        if self.config.mode == 'train':
            # Build Optimizers
            self.s_e_optimizer = optim.Adam((list(self.summarizer.s_lstm.parameters()) + list(self.summarizer.vae.tr.parameters()))+ list(self.linear_compress.parameters()), lr=self.config.lr)

            self.d_optimizer = optim.Adam(list(self.summarizer.vae.d_lstm.parameters())+ list(self.linear_compress.parameters()), lr=self.config.lr)
