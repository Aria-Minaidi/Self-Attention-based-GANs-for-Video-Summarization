...
sys.path.append('/content/drive/MyDrive/SUM-GAN-STD/slp')
...
def is_url(inp: Optional[str]) -> types1.ValidationResult:
...
def is_file(inp: Optional[str]) -> types1.ValidationResult:
...
def yaml_load(fname: str) -> types1.GenericDict:
...
def yaml_dump(data: types1.GenericDict, fname: str) -> None:
...
def json_load(fname: str) -> types1.GenericDict:
...
def json_dump(data: types1.GenericDict, fname: str) -> None:
